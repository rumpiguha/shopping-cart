...
namespace ShopCloudsTest.ServiceTests
{
    ...
    public class CurrencyServiceTests
    {
        ...
        private readonly Mock<ILogger<CurrencyService>> logger;
        ...
        {
            logger = new Mock<ILogger<CurrencyService>>();
        ...
        public async Task GetProductListAsync_Should_ReturnProductsList()
        {
            ...
            currencyService = new CurrencyService(httpClient, options.Object, logger.Object);
            ...
            .ReturnsAsync(new HttpResponseMessage()
            {
                ...
                Content = new StringContent(JsonConvert.SerializeObject(GetRateList()), Encoding.UTF8, "application/json")
            })
            .Verifiable();

            //Act
            var result = await currencyService.GetFxRatesAsync();
        ...
        [TestMethod]
        [ExpectedException(typeof(HttpResponseException), "Error while fetching ExchangeRates.")]
        public async Task GetProductListAsync_Should_ThrowException()
        {
            //Arrange
            options.Setup(x => x.Value).Returns(apiSettings);
            HttpClient httpClient = new HttpClient(httpMessageHandlerMock.Object);
            ...
            //Act
            await currencyService.GetFxRatesAsync();
        }
